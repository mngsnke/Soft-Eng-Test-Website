<div class="card" style="width:500px;height:300px;margin-top:20%;padding:20px;background-color: #fffa91">
    <h1 class="mx-auto">Log In</h1><br>
        <form action="php/login.php">
            ...
            <div class="form-group">
                <input type="password" class="form-control" id="password" placeholder="Password" name="password-login">
            </div>
            <button type="submit" class="btn btn-success">Log in</button>
            <a style="margin-left:125px;">Don't have an account yet? <a href="#!register">Register</a></a>
        </form>
</div>